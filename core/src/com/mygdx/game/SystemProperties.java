...
public class SystemProperties {
    ...
    final public static Vector[][] globalCoordinates = new Vector[4][12];
    final public static Vector[][] globalVelocities = new Vector[4][12];;
...
//    }; // hashmap with all entities presented in the system. Key is represented by the name and value is index of the entity
    ...
    final public static Vector[] initCoordinates = {
    ...
    final public static Vector[] initVelocities = {new Vector(0.0, 0.0, 0.0),
        ...
        new Vector(5.05251577575409,-29.3926687625899,0.00170974277401292),new Vector(4.34032634654904,-30.0480834180741,-0.0116103535014229),
    ...
    public static void generateState(){
        ...
        for (int i = 0; i < 12; i++) {
            ...
            globalCoordinates[0][i] = globalCoordinates[1][i] =  globalCoordinates[2][i] =  globalCoordinates[3][i] = initCoordinates[i];
        }

        for (int i = 0; i < 12; i++) {
            
            globalVelocities[0][i] = globalVelocities[1][i] = globalVelocities[2][i] = globalVelocities[3][i] = initVelocities[i];
        }
